...
================================
-GRISLI 
-run_GRISLI.sh (shell script for temporarily setting environment variables and executing 
                the application)
   -to run the shell script, type
   
       ./run_GRISLI.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v96, run the shell script as:
       ...
       ./run_GRISLI.sh /mathworks/home/application/v96
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_GRISLI.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
${LD_LIBRARY_PATH}:MR/v96/runtime/glnxa64:MR/v96/bin/glnxa64:MR/v96/sys/os/glnxa64:MR/v96/sys/opengl/lib/glnxa64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_GRISLI.sh 
