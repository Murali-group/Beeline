...
epochs = sys.argv[5]   #### iterations of trainning, with GPU 1080, each epoch takes about 60s
...
for test_indel in range(1, kFolds + 1): ################## three fold cross validation
    test_TF = [test_indel]
    ...
    save_dir = sys.argv[4] + '/_xxjust_two_3fold_db_lr002_YYYY_saved_models_T_32-32-64-64-128-128-512_e'+str(epochs)
    # if num_classes >2:
